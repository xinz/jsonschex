...
### Bug Fixes and Improvements
  ...
  * Adapt the official `idn-email` format test suite's lone UTF-16 surrogate case for Elixir JSON decoders and reject ill-formed UTF-8 input during `idn-email` validation
